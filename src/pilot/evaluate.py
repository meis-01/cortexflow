...
ap.add_argument("--Y",default="data/pilot/Y.npy"); ap.add_argument("--Yhat",default="artifacts/pilot/Yhat.npy")
ap.add_argument("--out_dir",default="artifacts/pilot/plots"); a=ap.parse_args()
